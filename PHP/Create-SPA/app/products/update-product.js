...
$.getJSON("http://create-spa/api/product/read_one.php?id=" + id, function(data){
...
$.getJSON("http://create-spa/api/category/read.php", function(data){
...
$(document).on('submit', '#update-product-form', function(){
    ...
    $.ajax({
        url: "http://create-spa/api/product/update.php",
        type : "POST",
